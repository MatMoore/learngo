		...
		if (_p12.ctor === 'NotStarted') {
			...
			var newRecord = A3(
				...
				_elm_lang$core$Native_Utils.update(
					_p13,
					{
						notes: {ctor: '::', _0: msg, _1: _p13.notes}
					}),
				_p12._2);
...
var _user$project$Game$newGame = function (boardSize) {
	return {
		...
		rules: {
			ctor: '::',
			_0: _user$project$Game$Rule(_user$project$Game$placePlayer),
			_1: {
				ctor: '::',
				_0: _user$project$Game$Rule(_user$project$Game$onePlayerPerTurnRule),
				_1: {
					ctor: '::',
					_0: _user$project$Game$Rule(_user$project$Game$oneStonePerPointRule),
					_1: {
						ctor: '::',
						_0: _user$project$Game$Rule(_user$project$Game$captureRule),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$View$chatItemView = function (item) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg$text(item),
			_1: {ctor: '[]'}
		});
};
	...
	function (config, centre, str) {
		return {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$cx(centre.x),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$cy(centre.y),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$r('4'),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$fill('dodgerblue'),
								_1: {ctor: '[]'}
							}
						}
					}
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$x(centre.x),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$y(centre.y),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$fontSize('6'),
								_1: {
									ctor: '::',
...
var _user$project$View$gridLine = F3(
	function (config, start, end) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$x1(start.x),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$x2(end.x),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$y1(start.y),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$y2(end.y),
							_1: {
								ctor: '::',
...
var _user$project$View$grid = function (config) {
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$fill('#dc7'),
							_1: {ctor: '[]'}
						}
					}
				}
	...
	var stars = A2(
		...
		config.stars);
	var linePositions = A2(_elm_lang$core$List$range, 0, config.size - 1);
	...
	return A2(
		_elm_lang$core$Basics_ops['++'],
		{ctor: '::', _0: background, _1: verticalLines},
...
var _user$project$View$stoneCircle = F3(
	function (config, svgPoint, options) {
		var extraOptions = A2(
			...
			{
				ctor: '::',
				_0: A2(_elm_lang$core$Maybe$map, _elm_lang$svg$Svg_Events$onClick, options.onClick),
				_1: {ctor: '[]'}
			});
		var spacing = _user$project$View$lineSpacing(config);
		...
		var coreOptions = {
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$cx(svgPoint.x),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$cy(svgPoint.y),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$r(stoneSize),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$fill(options.fillColor),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$View$buttons = function (config) {
	...
	var numbers = A2(_elm_lang$core$List$range, 0, config.size - 1);
	var allPoints = A2(
		_elm_lang$core$List$concatMap,
		function (x) {
			return A2(
	...
	function (config, board) {
		...
		var addStone = F2(
			function (_p5, elements) {
				...
				return {
					ctor: '::',
					_0: A2(viewPlayer, _p6._0, _p6._1),
					_1: elements
				};
			});
		return A3(
